  ...
  return (
    <main className="grid min-h-screen place-items-center px-6 py-12">
      <section className="w-full max-w-2xl rounded-3xl bg-white p-10 shadow-[0_24px_60px_rgba(16,24,40,0.12)]">
        <p className="m-0 text-sm uppercase tracking-[0.08em] text-slate-600">Apex Scholarship Pipeline</p>
        ...
        <p className="mt-4 text-base text-slate-700">
          Server-rendered with Next.js and Prisma PostgreSQL authoritative layer.
        </p>
      </section>
    </main>
  );
